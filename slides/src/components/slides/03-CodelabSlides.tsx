    ...
    <div className="flex flex-col items-center justify-center h-full space-y-12 px-8">
      ...
      <div className="text-center space-y-4">
        <div className="bg-accent/10 rounded-lg p-6 border border-accent/30 max-w-4xl">
          <p className="text-xl text-muted-foreground italic">
            *10.000 selon le syndicat des llamas 🦙
          </p>
        </div>
  ...
  const coaches = [
    {
      ...
      color: "text-primary",
      subtitle: "GenAI community leader"
    },
    {
      name: "Maxime Courant",
      emoji: "🚀",
    ...
    <div className="flex flex-col items-center justify-center h-full space-y-10 px-8">
      ...
      <div className="flex flex-wrap justify-center gap-8 w-full max-w-6xl">
        {tools.map((tool, index) => {
          ...
          <div
            key={index}
            className="w-full md:w-[calc(50%-1rem)] bg-card/40 rounded-lg p-6 border border-primary/20 space-y-4"
          >
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full space-y-10 px-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-2xl text-muted-foreground">
          4 étapes pour devenir un maître de l'agentic-coding
        </p>
      </div>
    ...
    <div className="flex flex-col items-center justify-center h-full space-y-10 px-8">
      ...
      <div className="flex flex-wrap justify-center gap-6 w-full max-w-6xl mx-auto">
        {requirements.map((req, index) => (
          <div key={index} className="w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] bg-card/40 rounded-lg p-6 border border-primary/20 space-y-4">
      ...
      <div className="flex flex-wrap justify-center gap-8 w-full max-w-4xl mx-auto">
        <div className="w-full md:w-[calc(50%-1rem)] bg-primary/10 rounded-lg p-6 border border-primary/30">
        ...
        <div className="w-full md:w-[calc(50%-1rem)] bg-accent/10 rounded-lg p-6 border border-accent/30">
